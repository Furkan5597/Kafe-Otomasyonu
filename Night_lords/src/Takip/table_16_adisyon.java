...
public class table_16_adisyon extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					table_16_adisyon frame = new table_16_adisyon();
	...
	public table_16_adisyon() {
		...
		try {
	        ...
	        ResultSet rs =st.executeQuery("select musteri_no from tables where table_id='16' ");
			...
			public void actionPerformed(ActionEvent e) {
				...
				toplam=topt+topk+topan+topat+topb+topd+topdk+topfr+topg+topkk+topm+topf+topmi+topp+tops+topsm+topsi+topsk+tophi+topsu+toptk+topw;
				 ...
				 try {
				        ...
				        Statement st=con.createStatement();	
				        if(tutar>0) {
				        	st.executeUpdate("Update tables SET  price='"+tutar+"' where table_id='16' ");
				        }
					 ...
					 if((int)spinner[i].getValue()>0)
					 {
						 try {
						        ...
						        Statement st=con.createStatement();		        		     			        
						        	...
						        	st.executeUpdate("INSERT INTO siparis_detay(sayi,product_price,siparisler,tarih,masa_numarasi,musteri_no)VALUES('"+(int)spinner[i].getValue()+"','"+price[i]+"','"+name[i]+"','"+tarih+"','16','"+musteri_no+"')");		        
					 ...
					 if((int)spinner1[i].getValue()>=1)
					 {
						 try {
						        ...
						        Statement st=con.createStatement();		        		     			        
						        	...
						        	st.executeUpdate("INSERT INTO siparis_detay(sayi,product_price,siparisler,tarih,masa_numarasi,musteri_no)VALUES('"+(int)spinner1[i].getValue()+"','"+pricet[i]+"','"+namet[i]+"','"+tarih+"','16','"+musteri_no+"')");		        
					 ...
					 if((int)spinner2[i].getValue()>0)
					 {
						 try {
						        ...
						        Statement st=con.createStatement();		        		     			        
						        	...
						        	st.executeUpdate("INSERT INTO siparis_detay(sayi,product_price,siparisler,tarih,masa_numarasi,musteri_no)VALUES('"+(int)spinner2[i].getValue()+"','"+priceay[i]+"','"+nameay[i]+"','"+tarih+"','16','"+musteri_no+"')");		        
					 ...
					 if((int)spinner3[i].getValue()>0)
					 {
						 try {
						        ...
						        Statement st=con.createStatement();		        		     			        
						        	...
						        	st.executeUpdate("INSERT INTO siparis_detay(sayi,product_price,siparisler,tarih,masa_numarasi,musteri_no)VALUES('"+(int)spinner3[i].getValue()+"','"+priceat[i]+"','"+nameat[i]+"','"+tarih+"','16','"+musteri_no+"')");		        
					 ...
					 if((int)spinner4[i].getValue()>0)
					 {
						 try {
						        ...
						        Statement st=con.createStatement();		        		     			        
						        	...
						        	st.executeUpdate("INSERT INTO siparis_detay(sayi,product_price,siparisler,tarih,masa_numarasi,musteri_no)VALUES('"+(int)spinner4[i].getValue()+"','"+pricebc[i]+"','"+namebc[i]+"','"+tarih+"','16','"+musteri_no+"')");		        
					 ...
					 if((int)spinner5[i].getValue()>0)
					 {
						 try {
						        ...
						        Statement st=con.createStatement();		        		     			        
						        	...
						        	st.executeUpdate("INSERT INTO siparis_detay(sayi,product_price,siparisler,tarih,masa_numarasi,musteri_no)VALUES('"+(int)spinner5[i].getValue()+"','"+pricedi[i]+"','"+namedi[i]+"','"+tarih+"','16','"+musteri_no+"')");		        
					 ...
					 if((int)spinner6[i].getValue()>0)
					 {
						 try {
						        ...
						        Statement st=con.createStatement();		        		     			        
						        	...
						        	st.executeUpdate("INSERT INTO siparis_detay(sayi,product_price,siparisler,tarih,masa_numarasi,musteri_no)VALUES('"+(int)spinner6[i].getValue()+"','"+pricedk[i]+"','"+namedk[i]+"','"+tarih+"','16','"+musteri_no+"')");		        
					 ...
					 if((int)spinner7[i].getValue()>0)
					 {
						 try {
						        ...
						        Statement st=con.createStatement();		        		     			        
						        	...
						        	st.executeUpdate("INSERT INTO siparis_detay(sayi,product_price,siparisler,tarih,masa_numarasi,musteri_no)VALUES('"+(int)spinner7[i].getValue()+"','"+pricef[i]+"','"+namef[i]+"','"+tarih+"','16','"+musteri_no+"')");		        
					 ...
					 if((int)spinner8[i].getValue()>0)
					 {
						 try {
						        ...
						        Statement st=con.createStatement();		        		     			        
						        	...
						        	st.executeUpdate("INSERT INTO siparis_detay(sayi,product_price,siparisler,tarih,masa_numarasi,musteri_no)VALUES('"+(int)spinner8[i].getValue()+"','"+pricefr[i]+"','"+namefr[i]+"','"+tarih+"','16','"+musteri_no+"')");		        
					 ...
					 if((int)spinner9[i].getValue()>0)
					 {
						 try {
						        ...
						        Statement st=con.createStatement();		        		     			        
						        	...
						        	st.executeUpdate("INSERT INTO siparis_detay(sayi,product_price,siparisler,tarih,masa_numarasi,musteri_no)VALUES('"+(int)spinner9[i].getValue()+"','"+priceg[i]+"','"+nameg[i]+"','"+tarih+"','16','"+musteri_no+"')");		        
					 ...
					 if((int)spinner10[i].getValue()>0)
					 {
						 try {
						        ...
						        Statement st=con.createStatement();		        		     			        
						        	...
						        	st.executeUpdate("INSERT INTO siparis_detay(sayi,product_price,siparisler,tarih,masa_numarasi,musteri_no)VALUES('"+(int)spinner10[i].getValue()+"','"+pricekk[i]+"','"+namekk[i]+"','"+tarih+"','16','"+musteri_no+"')");		        
					 ...
					 if((int)spinner11[i].getValue()>0)
					 {
						 try {
						        ...
						        Statement st=con.createStatement();		        		     			        
						        	...
						        	st.executeUpdate("INSERT INTO siparis_detay(sayi,product_price,siparisler,tarih,masa_numarasi,musteri_no)VALUES('"+(int)spinner11[i].getValue()+"','"+pricem[i]+"','"+namem[i]+"','"+tarih+"','16','"+musteri_no+"')");		        
					 ...
					 if((int)spinner12[i].getValue()>0)
					 {
						 try {
						        ...
						        Statement st=con.createStatement();		        		     			        
						        	...
						        	st.executeUpdate("INSERT INTO siparis_detay(sayi,product_price,siparisler,tarih,masa_numarasi,musteri_no)VALUES('"+(int)spinner12[i].getValue()+"','"+pricems[i]+"','"+namems[i]+"','"+tarih+"','16','"+musteri_no+"')");		        
					 ...
					 if((int)spinner13[i].getValue()>0)
					 {
						 try {
						        ...
						        Statement st=con.createStatement();		        		     			        
						        	...
						        	st.executeUpdate("INSERT INTO siparis_detay(sayi,product_price,siparisler,tarih,masa_numarasi,musteri_no)VALUES('"+(int)spinner13[i].getValue()+"','"+pricep[i]+"','"+namep[i]+"','"+tarih+"','16','"+musteri_no+"')");		        
					 ...
					 if((int)spinner14[i].getValue()>0)
					 {
						 try {
						        ...
						        Statement st=con.createStatement();		        		     			        
						        	...
						        	st.executeUpdate("INSERT INTO siparis_detay(sayi,product_price,siparisler,tarih,masa_numarasi,musteri_no)VALUES('"+(int)spinner14[i].getValue()+"','"+prices[i]+"','"+names[i]+"','"+tarih+"','16','"+musteri_no+"')");		        
					 ...
					 if((int)spinner15[i].getValue()>0)
					 {
						 try {
						        ...
						        Statement st=con.createStatement();		        		     			        
						        	...
						        	st.executeUpdate("INSERT INTO siparis_detay(sayi,product_price,siparisler,tarih,masa_numarasi,musteri_no)VALUES('"+(int)spinner15[i].getValue()+"','"+pricesm[i]+"','"+namesm[i]+"','"+tarih+"','16','"+musteri_no+"')");		        
					 ...
					 if((int)spinner16[i].getValue()>0)
					 {
						 try {
						        ...
						        Statement st=con.createStatement();		        		     			        
						        	...
						        	st.executeUpdate("INSERT INTO siparis_detay(sayi,product_price,siparisler,tarih,masa_numarasi,musteri_no)VALUES('"+(int)spinner16[i].getValue()+"','"+pricesi[i]+"','"+namesi[i]+"','"+tarih+"','16','"+musteri_no+"')");		        
					 ...
					 if((int)spinner17[i].getValue()>0)
					 {
						 try {
						        ...
						        Statement st=con.createStatement();		        		     			        
						        	...
						        	st.executeUpdate("INSERT INTO siparis_detay(sayi,product_price,siparisler,tarih,masa_numarasi,musteri_no)VALUES('"+(int)spinner17[i].getValue()+"','"+pricesk[i]+"','"+namesk[i]+"','"+tarih+"','16','"+musteri_no+"')");		        
					 ...
					 if((int)spinner18[i].getValue()>0)
					 {
						 try {
						        ...
						        Statement st=con.createStatement();		        		     			        
						        	...
						        	st.executeUpdate("INSERT INTO siparis_detay(sayi,product_price,siparisler,tarih,masa_numarasi,musteri_no)VALUES('"+(int)spinner18[i].getValue()+"','"+pricehi[i]+"','"+namehi[i]+"','"+tarih+"','16','"+musteri_no+"')");		        
					 ...
					 if((int)spinner19[i].getValue()>0)
					 {
						 try {
						        ...
						        Statement st=con.createStatement();		        		     			        
						        	...
						        	st.executeUpdate("INSERT INTO siparis_detay(sayi,product_price,siparisler,tarih,masa_numarasi,musteri_no)VALUES('"+(int)spinner19[i].getValue()+"','"+pricesu[i]+"','"+namesu[i]+"','"+tarih+"','16','"+musteri_no+"')");		        
					 ...
					 if((int)spinner20[i].getValue()>0)
					 {
						 try {
						        ...
						        Statement st=con.createStatement();		        		     			        
						        	...
						        	st.executeUpdate("INSERT INTO siparis_detay(sayi,product_price,siparisler,tarih,masa_numarasi,musteri_no)VALUES('"+(int)spinner20[i].getValue()+"','"+pricetk[i]+"','"+nametk[i]+"','"+tarih+"','16','"+musteri_no+"')");		        
					 ...
					 if((int)spinner21[i].getValue()>0)
					 {
						 try {
						        ...
						        Statement st=con.createStatement();		        		     			        
						        	...
						        	st.executeUpdate("INSERT INTO siparis_detay(sayi,product_price,siparisler,tarih,masa_numarasi,musteri_no)VALUES('"+(int)spinner21[i].getValue()+"','"+pricew[i]+"','"+namew[i]+"','"+tarih+"','16','"+musteri_no+"')");		        
				 ...
				 table_16_adisyon f1=new table_16_adisyon();
				 f1.setVisible(true);
				 dispose();
			}
		});
...
try {
	        ...
	        Connection con=conn.connDb();
	        Statement st=con.createStatement();			       	        
	        ResultSet rs =st.executeQuery("select tarih from tables where table_id='16' ");
	        while(rs.next())
	        {
...
try {
	        ...
	        Connection con=conn.connDb();
	        Statement st=con.createStatement();			       	        
	        ResultSet rs =st.executeQuery("select product_price from siparis_detay where masa_numarasi='16' ");
	        while(rs.next())
	        {
		...
		btnNewButton_2.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				adisyon_16 fad1=new adisyon_16();
